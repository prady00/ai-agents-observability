...
llm = ChatOpenAI(api_key=openai_api_key, temperature=0,callback_manager=callback_manager)  # Pass the API key from env variables

# Create the agent
agent = initialize_agent(tools, llm, agent=AgentType.ZERO_SHOT_REACT_DESCRIPTION, verbose=True,callback_manager=callback_manager)
